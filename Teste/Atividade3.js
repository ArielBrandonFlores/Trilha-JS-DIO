...
function percentualImposto(valor, percentual) {
  return valor * (percentual / 100);
}

function pagarAliquota(salario) {
...
const aliquotaImpoto = pagarAliquota(valorSalarioBruto);
const valorImposto = percentualImposto(valorSalarioBruto, aliquotaImpoto);
const valorTransferir = valorSalarioBruto - valorImposto + valorAdicionalBeneficios;
